  ...
  return (
    ...
    >
      ...
      <div className="my-8 mx-auto w-full text-lg text-center max-w-[800px] space-y-5">
        <p>
          Hi, I'm Hannah 👋🏾 and I have recently made a career shift from special
          needs education to Full-Stack Developer through the School Of Code
          bootcamp.
        </p>
        <p>
          I am a creative and empathetic person who loves to solve problems and
          work with others. I am a self driven learner who is always looking for
        ...
        <p>
          ...
          the School of Code. Now that I have completed the bootcamp, I am
          looking for a role where I can continue to learn, grow as a developer
          and make this space more inclusive for others.
        </p>
        <p>
          When I'm not coding, you will find me personalising my clothes with
          embroidery 🪡, rewatching the Harry Potter movies 🦉, or maybe even
